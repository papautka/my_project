...
declare -a tests=(
"s VAR test_text_grep.txt"
"for  VAR s21_grep.c s21_grep.h Makefile"
"for s21_grep.c VAR"
"-e for -e ^int VAR s21_grep.c s21_grep.h Makefile"
...
"-ls for no_file.txt test_2_grep.txt"
